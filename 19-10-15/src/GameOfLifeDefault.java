 ...
 */
public class GameOfLifeDefault extends JFrame implements ActionListener {
    ...
    public static void main(String[] args) {
        ...
        JFrame game = new GameOfLifeDefault();
        game.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        game.setTitle("Conway's Game of Life");
        //game.setIconImage(new ImageIcon(GameOfLifeDefault.class.getResource("/images/logo.png")).getImage());
